...
.definelabel aiseg1_end, 0x80378800
...
ADDIU   A0, A0, 0xB080
; RAM dest
LUI     A0, 0x8036 ; 2 instructions, 0x80367460
ORI     A0, A0, 0x7460
; ROM srcStart
LUI     A1, 0x0010; 2 instructions, 0x10C280
ORI     A1, A1, 0xC280
; ROM srcEnd
LUI     A2, ((0x0010C280+0x0001139F) >> 16) ; 0x10C280 (start) + 0x1139F (end)
